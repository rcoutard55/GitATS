<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPages/ats_rrhh.Master" CodeBehind="Employe_Database.aspx.vb" Inherits="American_Transit_Services_LLC.Employe_Database" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row">
        <div class="col-md-12 mx-auto">
            ...
            <div class="row">
                <div class="col">
                    <label class="header-text">Employe Database</label>
                </div>
            </div>
            <br />
            <div class="row">
                ...
                <div class="col">
                    <div class="card" style="height:100vh;">
                        ...
                        <div class="card-body" style="overflow-y:scroll">
                            <asp:GridView ID="grd_employe" Class="container-fluid table table-strip table-bordered" AutoGenerateColumns="False" runat="server" >
                                <Columns>
                                    ...
                                    <asp:TemplateField ItemStyle-HorizontalAlign="center">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="ll_view" OnClick="ll_view_Click" ForeColor="SteelBlue" Font-Bold="true" runat="server"><i class="fas fa-eye"></i></asp:LinkButton>
            ...
            <div class="row">
                <asp:Label ID="lbl_employe_id" runat="server" Visible="false" Text="" />
            </div>
        </div>
